...
The .exe tools from `x86|x64-upstreams-encoders.7z` can be placed anywhere. However, 1cenc has an auto-import feature that searches the following locations, making subsequent import operations easier:
